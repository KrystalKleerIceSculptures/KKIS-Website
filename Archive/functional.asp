         ...
         <table width="100%" cellpadding="5" bgcolor="#003366">
             ...
             <tr>
			   ...
			   <table>
                 ...
                 <tr>
                   <td><a href="photo.asp?ID=38">Functional Ideas</a><br />
                       <span class="SubMenu">
                       <%
Dim oConn, oRs
...
%>
                 ...
                 <tr>
                   <td><a href="photo.asp?ID=3">Mini Centerpieces</a></td>
                 </tr>
                 <tr>
      ...
      <table width="100%">
        <tr>
          <td class="Header">Functional Ideas</td>
        </tr>
        <tr>
          <td>Content</td>
        </tr>
